...
The Aitoff projection is a compromise projection first described in the late 1800's by David Aitoff. It looks very similar to, and was invented just shortly before, the much better known Hammer (or Hammer-Aitoff) projection. The Hammer projection has the nice property of being equal area, while the original Aitoff projection, based on the azimuthal equidistant projection, ends up preserving no cartographic properties. Hammer's work was used much more throughout the 20th century, but was often mistakenly attributed Aitoff (even by [NASA](https://asd.gsfc.nasa.gov/archive/idlastro/ftp/pro/astro/aitoff.pro)!) due to the two projections' visual similarity and Hammer's own careful citation of Aitoff's work as his inspiration.
...
While Kunimune's software has had the closed form inverse for years, it's still missing from every industry-dominant library that downstream tools depend on. And the algebraic identity formulation does look new, since it makes the closed-form's existence obvious from the equations themselves instead of needing a geometric decomposition through a different projection. The PRs are still worth filing. I just owe Kunimune a citation for having gotten there first.
